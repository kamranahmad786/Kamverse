...
export default function About() {
  return (
    <section
      id="about"
      className="flex items-center justify-center w-full min-h-screen px-6 bg-white dark:bg-gray-900"
    >
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-12">

        {/* Profile Image */}
        <div className="w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden border border-gray-300 dark:border-gray-700 shadow-md flex-shrink-0">
          <img
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          {/* Description */}
          <p className="mt-6 text-base md:text-lg text-gray-700 dark:text-gray-400 leading-relaxed max-w-xl">
            Hands-on experience building scalable, maintainable and 
            performance-oriented applications, I specialize in modern full-stack development using 
            <span className="font-semibold text-gray-900 dark:text-gray-200"> React, Node.js, Express, MongoDB</span>.
            I also work with cloud deployments, API integrations, and building production-grade UI/UX.
          </p>
