...
export default function Experience() {
  const experiences = [
    ...
    }, 
    {
      ...
      description: [
        "Built production-ready interfaces.",
        "Optimized performance and bundle size.",
        "Implemented reusable UI components in a MERN environment.",
      ],
    },

    {
      ...
      description: [
        ...
        "Helped organize technical bootcamps and workshops.",
      ],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto">
        {/* Timeline Lines */}
        <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-[2px] bg-gray-300 dark:bg-gray-700" />
        <div className="md:hidden absolute left-4 top-0 bottom-0 w-[2px] bg-gray-300 dark:bg-gray-700" />
        ...
        <div className="flex flex-col gap-16">
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute md:left-1/2 left-4 w-4 h-4 rounded-full bg-gray-700 dark:bg-gray-300 border-4 border-white dark:border-gray-900 transform md:-translate-x-1/2 z-20" />

              {/* Card */}
              <div className="w-full md:w-[48%] bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md transition-all px-6 py-6">
